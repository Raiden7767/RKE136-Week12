...
app.get('/', (req, res) => {
    ...
    let url = 'https://api.themoviedb.org/3/movie/550988?api_key=b200f8a206e25b65731194f24cb3fe63';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=b200f8a206e25b65731194f24cb3fe63&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=b200f8a206e25b65731194f24cb3fe63&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=4c6de043`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
